...
var ClienteService = /** @class */ (function () {
    ...
    ClienteService.prototype.getClientes = function (page, size, order, asc) {
        return this.http.get(this.urlEndPoint + ("?page=" + page + "&size=" + size + "&order=" + order + "&asc=" + asc + "&filtro="));
    };
    ClienteService.prototype.getClientesConFiltro = function (page, size, order, asc, filtro) {
    ...
    ClienteService.prototype.create = function (cliente) {
        return this.http.post(this.urlEndPoint, cliente).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["catchError"])(function (e) {
            if (e.status == 400) {
    ...
    ClienteService.prototype.update = function (cliente) {
        return this.http.put(this.urlEndPoint + "/" + cliente.id, cliente).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["catchError"])(function (e) {
            if (e.status == 400) {
                return Object(rxjs__WEBPACK_IMPORTED_MODULE_2__["throwError"])(e);
            }
            console.error(e.error.mensaje);
    ...
    ClienteService.prototype.delete = function (id) {
        return this.http.delete(this.urlEndPoint + "/" + id).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["catchError"])(function (e) {
            console.error(e.error.mensaje);
            sweetalert2__WEBPACK_IMPORTED_MODULE_6___default()(e.error.mensaje, e.error.error, 'error');
            return Object(rxjs__WEBPACK_IMPORTED_MODULE_2__["throwError"])(e);
        }));
...
var ClientesComponent = /** @class */ (function () {
    function ClientesComponent(clienteService, router) {
    ...
    ClientesComponent.prototype.cargarClientes = function () {
        var _this = this;
        this.clienteService.getClientes(this.page, this.size, this.order, this.asc).subscribe(function (rtaJson) {
            _this.clientes = rtaJson.clientes;
            _this.isFirst = rtaJson.paginador.first;
            _this.isLast = rtaJson.paginador.last;
            _this.totalPages = new Array(rtaJson.paginador.totalPaginas);
            _this.numerosFooterPaginador = rtaJson.paginador.paginas;
        }, function (err) {
    ...
    ClientesComponent.prototype.sort = function () {
        this.asc = !this.asc;
        this.cargarClientes();
    };
    ClientesComponent.prototype.rewind = function () {
        if (!this.isFirst) {
            this.page--;
            this.cargarClientes();
        }
    };
    ClientesComponent.prototype.forward = function () {
        if (!this.isLast) {
            this.page++;
            this.cargarClientes();
        }
    };
    ClientesComponent.prototype.setPage = function (page) {
        this.page = page;
        this.cargarClientes();
    };
    ClientesComponent.prototype.setOrder = function (order) {
        this.order = order;
        this.cargarClientes();
    };
    ClientesComponent.prototype.onChangeSize = function () {
...
var FormClienteComponent = /** @class */ (function () {
    function FormClienteComponent(clienteService, router, activatedRoute) {
        this.clienteService = clienteService;
        this.router = router;
    ...
    FormClienteComponent.prototype.create = function () {
        var _this = this;
        this.clienteService.create(this.cliente).subscribe(function (respuestaJson) {
            _this.router.navigate(['/clientes']);
    ...
    FormClienteComponent.prototype.update = function () {
        var _this = this;
        this.clienteService.update(this.cliente).subscribe(function (respuestaJson) {
            _this.router.navigate(['/clientes']);
...
var FacturaService = /** @class */ (function () {
    function FacturaService(http, router) {
        this.http = http;
        this.router = router;
        this.urlEndPoint = _utils_appSettings__WEBPACK_IMPORTED_MODULE_5__["AppSettings"].API_ENDPOINT + '/api/facturas';
    }
    FacturaService.prototype.obtenerFacturas = function (page, size, order, asc, fechaDesde, fechaHasta) {
    ...
    FacturaService.prototype.obtenerProximoNroFactura = function (tipoComprobante, claseComprobante) {
    ...
    FacturaService.prototype.create = function (factura) {
        return this.http.post(this.urlEndPoint, factura).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["catchError"])(function (e) {
            if (e.status == 400) {
                var errores = void 0;
    ...
    FacturaService.prototype.getFactura = function (id) {
        var _this = this;
        return this.http.get(this.urlEndPoint + "/" + id).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["catchError"])(function (e) {
            _this.router.navigate(['/facturas']);
            console.error(e.error.mensaje);
            sweetalert2__WEBPACK_IMPORTED_MODULE_6___default()('Error al editar', e.error.mensaje, 'error');
            return Object(rxjs__WEBPACK_IMPORTED_MODULE_2__["throwError"])(e);
        }));
    };
    FacturaService.prototype.update = function (factura) {
        return this.http.put(this.urlEndPoint + "/" + factura.idFactura, factura).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["catchError"])(function (e) {
            if (e.status == 400) {
                return Object(rxjs__WEBPACK_IMPORTED_MODULE_2__["throwError"])(e);
            }
            console.error(e.error.mensaje);
...
var FacturaItem = /** @class */ (function () {
...
var FormFacturaComponent = /** @class */ (function () {
    function FormFacturaComponent(productoService, facturaService, clienteService, router, activatedRoute) {
    ...
    FormFacturaComponent.prototype.ngOnInit = function () {
        this.limpiarVariables();
        this.cargarClientes();
        this.cargarProductos();
    };
    FormFacturaComponent.prototype.print = function () {
    ...
    FormFacturaComponent.prototype.limpiarVariables = function () {
    ...
    FormFacturaComponent.prototype.agregarItem = function () {
    ...
    FormFacturaComponent.prototype.eliminarItem = function (item) {
        var index = this.factura.items.indexOf(item);
        if (index !== -1) {
    ...
    FormFacturaComponent.prototype.generarFacturacion = function () {
        var _this = this;
        console.log(this.factura);
        this.facturaService.create(this.factura).subscribe(function (rtaJson) {
            _this.factura = rtaJson.factura;
            ...
            _this.errores = e.error.errors;
            console.error('Codigo de error desde el backend: ' + e.status);
            console.error(e.error.errors);
        });
    };
    FormFacturaComponent.prototype.finalizarFacturacion = function () {
        this.limpiarVariables();
        this.router.navigate(['/facturas']);
    };
    FormFacturaComponent.prototype.create = function () {
        var _this = this;
        console.log(this.factura);
        this.facturaService.create(this.factura).subscribe(function (respuestaJson) {
            _this.router.navigate(['/facturas']);
    ...
    FormFacturaComponent.prototype.update = function () {
        var _this = this;
        this.facturaService.update(this.factura).subscribe(function (respuestaJson) {
            _this.router.navigate(['/facturas']);
    ...
    FormFacturaComponent.prototype.cargarProductos = function () {
        var _this = this;
        this.productoService.getProductosConFiltro(this.pageProductos, this.sizeProductos, this.orderProductos, this.ascProductos, this.filtroProductos).subscribe(function (respuestaJson) {
            _this.productos = respuestaJson.productos;
            _this.isFirstProductos = respuestaJson.paginador.first;
            _this.isLastProductos = respuestaJson.paginador.last;
            _this.totalPagesProductos = new Array(respuestaJson.paginador.totalPaginas);
            _this.numerosFooterPaginadorProductos = respuestaJson.paginador.paginas;
        }, function (err) {
            /*
    ...
    FormFacturaComponent.prototype.sortProductos = function () {
        this.ascProductos = !this.ascProductos;
        this.cargarProductos();
    };
    FormFacturaComponent.prototype.rewindProductos = function () {
        if (!this.isFirstProductos) {
            this.pageProductos--;
            this.cargarProductos();
        }
    };
    FormFacturaComponent.prototype.forwardProductos = function () {
        if (!this.isLastProductos) {
            this.pageProductos++;
            this.cargarProductos();
        }
    };
    FormFacturaComponent.prototype.setPageProductos = function (page) {
        this.pageProductos = page;
        this.cargarProductos();
    };
    FormFacturaComponent.prototype.setOrderProductos = function (order) {
        this.orderProductos = order;
        this.cargarProductos();
    };
    FormFacturaComponent.prototype.seleccionarProducto = function (producto) {
        this.itemNuevo.producto = producto;
    };
    FormFacturaComponent.prototype.borrarSeleccionProducto = function () {
        this.itemNuevo.producto = null;
    };
    FormFacturaComponent.prototype.cargarClientes = function () {
        var _this = this;
        this.clienteService.getClientesConFiltro(this.pageClientes, this.sizeClientes, this.orderClientes, this.ascClientes, this.filtroClientes).subscribe(function (rtaJson) {
            _this.clientes = rtaJson.clientes;
            _this.isFirstClientes = rtaJson.paginador.first;
            _this.isLastClientes = rtaJson.paginador.last;
            _this.totalPagesClientes = new Array(rtaJson.paginador.totalPaginas);
            _this.numerosFooterPaginadorClientes = rtaJson.paginador.paginas;
        }, function (err) {
            console.error('Codigo de error desde el backend: ' + err.status);
        });
    };
    FormFacturaComponent.prototype.sortClientes = function () {
        this.ascClientes = !this.ascClientes;
        this.cargarClientes();
    };
    FormFacturaComponent.prototype.rewindClientes = function () {
        if (!this.isFirstClientes) {
            this.pageClientes--;
            this.cargarClientes();
        }
    };
    FormFacturaComponent.prototype.forwardClientes = function () {
        if (!this.isLastClientes) {
            this.pageClientes++;
            this.cargarClientes();
        }
    };
    FormFacturaComponent.prototype.setPageClientes = function (page) {
        this.pageClientes = page;
        this.cargarClientes();
    };
    FormFacturaComponent.prototype.setOrderClientes = function (order) {
        this.orderClientes = order;
        this.cargarClientes();
    };
    FormFacturaComponent.prototype.seleccionarCliente = function (cliente) {
    ...
    FormFacturaComponent.prototype.desseleccionarCliente = function () {
        this.factura.cliente = new _clientes_cliente__WEBPACK_IMPORTED_MODULE_4__["Cliente"]();
        this.factura.claseComprobante = '-';
        this.factura.nroComprobante = '-';
    };
    FormFacturaComponent.prototype.getProximoNroFactura = function (claseComprobante) {
        var _this = this;
        this.facturaService.obtenerProximoNroFactura('FACTURA', claseComprobante).subscribe(function (respuestaJson) {
            _this.factura.nroComprobante = respuestaJson.proximoNroFactura;
        }, function (err) {
            console.error('Codigo de error desde el backend: ' + err.status);
        });
    };
    FormFacturaComponent.prototype.omit_special_char = function (event) {
        var k;
    ...
    FormFacturaComponent.ctorParameters = function () { return [
...
var HeaderComponent = /** @class */ (function () {
    ...
    HeaderComponent.prototype.estaLogeado = function () {
        return this.authService.estaLogeado();
    };
    HeaderComponent.prototype.usuarioLogeado = function () {
...
var LibroIvaVentasComponent = /** @class */ (function () {
    function LibroIvaVentasComponent(facturaService) {
        this.facturaService = facturaService;
        this.page = 0;
        this.size = 5;
    ...
    LibroIvaVentasComponent.prototype.ngOnInit = function () {
        this.fechaDesde = null;
        this.fechaHasta = null;
    };
    LibroIvaVentasComponent.prototype.cargarFacturas = function () {
        var _this = this;
        ...
        this.facturaService.obtenerFacturas(this.page, this.size, this.order, this.asc, this.fechaDesdeString, this.fechaHastaString).subscribe(function (rtaJson) {
            _this.facturas = rtaJson.facturas;
            _this.isFirst = rtaJson.paginador.first;
            _this.isLast = rtaJson.paginador.last;
            _this.totalPages = new Array(rtaJson.paginador.totalPaginas);
            _this.numerosFooterPaginador = rtaJson.paginador.paginas;
    ...
    LibroIvaVentasComponent.prototype.sort = function () {
        this.asc = !this.asc;
        this.cargarFacturas();
    };
    LibroIvaVentasComponent.prototype.rewind = function () {
        if (!this.isFirst) {
            this.page--;
            this.cargarFacturas();
        }
    };
    LibroIvaVentasComponent.prototype.forward = function () {
        if (!this.isLast) {
            this.page++;
            this.cargarFacturas();
        }
    };
    LibroIvaVentasComponent.prototype.setPage = function (page) {
        this.page = page;
        this.cargarFacturas();
    };
    LibroIvaVentasComponent.prototype.setOrder = function (order) {
        this.order = order;
        this.cargarFacturas();
    };
    LibroIvaVentasComponent.prototype.onChangeSize = function () {
        console.log(this.size);
        this.cargarFacturas();
    };
    LibroIvaVentasComponent.ctorParameters = function () { return [
    ...
    return LibroIvaVentasComponent;
}());
...
var AuthInterceptorService = /** @class */ (function () {
    ...
    AuthInterceptorService.prototype.intercept = function (req, next) {
        ...
        return next.handle(request).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["catchError"])(function (err) {
            ...
            var matches = err.message.match(new RegExp(JsonParseError, 'ig'));
...
var AuthService = /** @class */ (function () {
    ...
    AuthService.prototype.login = function (usuario) {
        return this.http.post(this.urlEndPoint, usuario, { headers: this.httpHeaders }).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["catchError"])(function (e) {
            if (e.status == 400) {
                return Object(rxjs__WEBPACK_IMPORTED_MODULE_2__["throwError"])(e);
            }
            console.error(e.error.mensaje);
    ...
    AuthService.prototype.estaLogeado = function () {
        if (localStorage.getItem('auth_token') == null)
            return false;
        else
            return true;
    };
    AuthService.prototype.getUsuarioLogeado = function () {
...
var LoginComponent = /** @class */ (function () {
    ...
    LoginComponent.prototype.login = function () {
        var _this = this;
        this.authService.login(this.usuario).subscribe(function (respuestaJson) {
...
var FormProductoComponent = /** @class */ (function () {
    function FormProductoComponent(productoService, router, activatedRoute) {
        this.productoService = productoService;
        this.router = router;
        this.activatedRoute = activatedRoute;
    ...
    FormProductoComponent.prototype.cargarProducto = function () {
        var _this = this;
        this.activatedRoute.params.subscribe(function (params) {
            var id = params['id'];
            if (id) {
                _this.productoService.getProducto(id).subscribe(function (rta) {
                    _this.producto = rta.producto;
                });
            }
        });
    };
    FormProductoComponent.prototype.create = function () {
        var _this = this;
        this.productoService.create(this.producto).subscribe(function (respuestaJson) {
    ...
    FormProductoComponent.prototype.update = function () {
        var _this = this;
        this.productoService.update(this.producto).subscribe(function (respuestaJson) {
            _this.router.navigate(['/productos']);
...
var ProductoService = /** @class */ (function () {
    function ProductoService(http, router) {
        this.http = http;
        this.router = router;
        this.urlEndPoint = _utils_appSettings__WEBPACK_IMPORTED_MODULE_5__["AppSettings"].API_ENDPOINT + '/api/productos';
    }
    ProductoService.prototype.getProductos = function (page, size, order, asc) {
        return this.http.get(this.urlEndPoint + ("?page=" + page + "&size=" + size + "&order=" + order + "&asc=" + asc));
    };
    ProductoService.prototype.getProductosConFiltro = function (page, size, order, asc, filtro) {
        return this.http.get(this.urlEndPoint + ("?page=" + page + "&size=" + size + "&order=" + order + "&asc=" + asc + "&filtro=" + filtro));
    };
    ProductoService.prototype.create = function (producto) {
        return this.http.post(this.urlEndPoint, producto).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["catchError"])(function (e) {
            if (e.status == 400) {
                return Object(rxjs__WEBPACK_IMPORTED_MODULE_2__["throwError"])(e);
            }
            console.error(e.error.mensaje);
    ...
    ProductoService.prototype.update = function (producto) {
        return this.http.put(this.urlEndPoint + "/" + producto.id, producto).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["catchError"])(function (e) {
            if (e.status == 400) {
                return Object(rxjs__WEBPACK_IMPORTED_MODULE_2__["throwError"])(e);
            }
            console.error(e.error.mensaje);
...
var ProductosComponent = /** @class */ (function () {
    function ProductosComponent(productoService, router) {
        this.productoService = productoService;
        this.router = router;
        this.page = 0;
        this.size = 5;
    ...
    ProductosComponent.prototype.cargarProductos = function () {
        var _this = this;
        this.productoService.getProductos(this.page, this.size, this.order, this.asc).subscribe(function (respuestaJson) {
            _this.productos = respuestaJson.productos;
            _this.isFirst = respuestaJson.paginador.first;
            _this.isLast = respuestaJson.paginador.last;
            _this.totalPages = new Array(respuestaJson.paginador.totalPaginas);
            _this.numerosFooterPaginador = respuestaJson.paginador.paginas;
        }, function (err) {
            /*this.errores = err.error.errors as string[];
            console.error('Codigo de error desde el backend: '+ err.status)
            console.error(err.error.errors)*/
    ...
    ProductosComponent.prototype.delete = function (producto) {
        ...
        sweetalert2__WEBPACK_IMPORTED_MODULE_4___default()({
            ...
            if (result.value) {
                _this.productoService.delete(producto.id).subscribe(function (response) {
                    _this.productos = _this.productos.filter(function (cli) { return cli !== producto; });
    ...
    ProductosComponent.prototype.sort = function () {
        this.asc = !this.asc;
        this.cargarProductos();
    };
    ProductosComponent.prototype.rewind = function () {
        if (!this.isFirst) {
            this.page--;
            this.cargarProductos();
        }
    };
    ProductosComponent.prototype.forward = function () {
        if (!this.isLast) {
            this.page++;
            this.cargarProductos();
        }
    };
    ProductosComponent.prototype.setPage = function (page) {
        this.page = page;
        this.cargarProductos();
    };
    ProductosComponent.prototype.setOrder = function (order) {
        this.order = order;
        this.cargarProductos();
    };
    ProductosComponent.prototype.onChangeSize = function () {
        console.log(this.size);
        this.page = 0;
        this.cargarProductos();
    };
